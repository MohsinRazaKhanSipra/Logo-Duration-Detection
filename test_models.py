...
GROUND_TRUTH_DURATIONS = {
    'Abha': 0, 'Aldiyar arabia': 0, 'Alhilal': 0, 'Almajed oud': 0, 'Altazij': 0,
    'BSF': 0, 'Bank Aljazira': 0, 'Basic': 0, 'Batuni': 0, 'Berain': 0,
    'Cheek Rib': 0, 'Direct': 0, 'Dojan': 6.5, 'Elba': 0, 'FIFA': 0,
    'Flow': 0, 'Flynas': 0, 'Gree': 0, 'Jahez': 0, 'Jazean': 0,
    'Jeddah': 0, 'Jeddah Central Development Company': 0, 'KAFD': 0, 'Kyan': 0,
    'Lateen': 1.5, 'Like card': 0, 'Mazaj': 0, 'Mazda': 0, 'Medgulf': 0,
    'Medplus': 0, 'Najran': 0, 'Pepsi': 0, 'Qaid': 10.7, 'RO': 0,
    'Red Sea Gobal': 0, 'Reef': 0, 'Riyadh bank': 0, 'Roshn Saudi League': 13,
    'SBL': 0, 'SIRC': 0, 'SPL': 0, 'STC': 0, 'Safwa aljwar': 0,
    'Saudia': 0, 'Savy': 2.66, 'Scai': 0, 'Site': 0, 'Tadavi': 0,
    'Tamini': 13.8, 'Tik tok': 0, 'Tree': 0.5, 'United pharm': 0, 'Urpay': 0,
    'V2M': 0, 'Visit Saudi': 0, 'Yadh': 0, 'Yelo': 0, 'maza': 0,
    'neoleap': 0, 'osus': 0, 'ro': 0, 'rsl': 0, 'samsung': 0, 'sca': 0
}
...
MODELS = {
    ...
    'roboflow_model': r'C:\Users\shop with hope\Desktop\Development\Computer Vision\Sir Sultan\Logo-Duration-Detection\model\yolov12s.pt'
}
